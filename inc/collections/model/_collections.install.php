 ...
 * @package evocore
 *
 * @version $Id: _collections.install.php 3462 2013-04-12 04:37:35Z yura $
 */
...
$schema_queries = array_merge( $schema_queries, array(
	'T_skins__skin' => array(
		...
		"CREATE TABLE T_skins__skin (
				...
				skin_type    enum('normal','feed','sitemap','mobile','tablet') NOT NULL default 'normal',
	...
	'T_blogs' => array(
		...
		"CREATE TABLE T_blogs (
			...
			blog_UID             VARCHAR(20),
			blog_type            ENUM( 'std', 'photo', 'group', 'forum', 'manual' ) DEFAULT 'std' NOT NULL,
	...
	'T_categories' => array(
		...
		"CREATE TABLE T_categories (
			...
			cat_urlname     varchar(255) NOT NULL COLLATE ascii_bin,
	...
	'T_items__item' => array(
		...
		"CREATE TABLE T_items__item (
			...
			post_status                 enum('published','community','deprecated','protected','private','review','draft','redirected') NOT NULL default 'published',
			...
			post_urltitle               VARCHAR(210) NOT NULL COLLATE ascii_bin,
	...
	'T_comments' => array(	// Note: pingbacks no longer supported, but previous pingbacks are to be preserved in the DB
		...
		"CREATE TABLE T_comments (
			...
			comment_status             ENUM('published','community','deprecated','protected','private','review','draft','trash') DEFAULT 'published' NOT NULL,
	...
	'T_coll_user_perms' => array(
		...
		"CREATE TABLE T_coll_user_perms (
			...
			bloguser_perm_poststatuses    set('review','draft','private','protected','deprecated','community','published','redirected') NOT NULL default '',
			...
			bloguser_perm_cmtstatuses     set('review','draft','private','protected','deprecated','community','published') NOT NULL default '',
			bloguser_perm_edit_cmt        ENUM('no','own','anon','lt','le','all') NOT NULL default 'no',
	...
	'T_coll_group_perms' => array(
		...
		"CREATE TABLE T_coll_group_perms (
			...
			bloggroup_perm_poststatuses    set('review','draft','private','protected','deprecated','community','published','redirected') NOT NULL default '',
			...
			bloggroup_perm_cmtstatuses     set('review','draft','private','protected','deprecated','community','published') NOT NULL default '',
			bloggroup_perm_edit_cmt        ENUM('no','own','anon','lt','le','all') NOT NULL default 'no',
