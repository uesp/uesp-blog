...
require "/home/uesp/secrets/uespblog.secrets";
 ...
 */
$db_config = array(
	'user'     => $blogDBUserName,     // your MySQL username
	'password' => $blogDBPassword,     // ...and password
	'name'     => $blogDBName,         // the name of the database
	'host'     => $blogDBHost,         // MySQL Server (typically 'localhost')
);
